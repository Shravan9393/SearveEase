...
const AuthFlow: React.FC<AuthFlowProps> = ({ isOpen, onClose, onAuthComplete }) => {
  ...
  }, [isCompletingGoogleProviderProfile, authMode, credentialsData, userType, providerData, customerProfileData.profileImage, completeProviderProfile, login, registerCustomer, registerProvider, onAuthComplete, onClose])
